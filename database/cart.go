...
import (
	...
	"github.com/MTOyelowo/go-ecommerce/models"
...
func BuyItemFromCart(ctx context.Context, userCollection *mongo.Collection, userID string) error {
	...
	//fetch the cart of the user and calculate the cart total
	// Then create an order with the items and add order to user collection
